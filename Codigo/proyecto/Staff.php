					...
					<td>Editar</td>
						...
						<?php
							...
							if(isset($_POST['edit']))
							{
								...
								$sql="UPDATE staff SET Nombre = '".$_POST['nnombre']."' WHERE = ";
								$Resultado=$conexion->query($sql);
							}
						...
						?>
						<form action="Staff.php" method="POST">
							<input type="text" name="nnombre" placeholder="Nuevo nombre...">
							<input type="text" name="nvigencia" placeholder="nueva vigencia...">
							<input type="text" name="napp" placeholder="Nuevo apellido paterno...">
							<input type="text" name="napm" placeholder="Nuevo apellido materno...">
						</form>
			</TBODY>
		</table>
		<h3>Buscar staff</h3>
